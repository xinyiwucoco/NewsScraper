...
def main():
  ...
  parser.add_option("-e", "--end_date", type=str, default=today,
            help="the end DATE of news scraping, in format of "
               "'YYYYmmdd'")
  parser.add_option("-d", "--num_days", type=int, default=1,
            help="NUMBER of days for news scraping")
  parser.add_option("-n", "--news_path", type=str, default="news",
            help="save news scraped to FOLDER")
  parser.add_option("-l", "--log_path", type=str, default="log",
